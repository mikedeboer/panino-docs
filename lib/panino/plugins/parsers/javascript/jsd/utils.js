...
exports.merge = function(originalObject, otherObject, mergeFunction) {
    ...
    _.each(_.intersection(originalKeys, otherKeys), function(collisionKey) {
        originalObject[collisionKey] = (_.isFunction(mergeFunction)) 
            ? mergeFunction(collisionKey, originalObject[collisionKey], otherObject[collisionKey]) 
            : otherObject[collisionKey];
    });
